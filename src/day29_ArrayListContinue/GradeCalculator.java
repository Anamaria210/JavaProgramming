...
public class GradeCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("The total number of A: "+ gradeOfA.size());
        System.out.println("The total number of B: "+ gradeOfB.size());
        System.out.println("The total number of C: "+ gradeOfC.size());
        System.out.println("The total number of D: "+ gradeOfD.size());
        System.out.println("The total number of F: "+ gradeOfF.size());

...
public class ArraysUtility {
    //print each integer of an integer array in separated lines
    ...
    // print each integer of a double array in separated lines
    ...
    // print each integer of an char array in separated lines
    ...
    //return maximum number for integer Array
    ...
    // return minimum number for integer
    public static int min(int[] numbers) {
        Arrays.sort(numbers);
        return numbers[0];

    }
    //return minimum number for double
    ...
    public static boolean contains(String[] array, String element) {
        ...
        boolean result = false;
        for (String each : array) {
            if (each.equals(element)) { // if any Array element is matching with the given element,it means the given elementsis contains in the Array
                result = true;
                break;
            }
    ...
    // adds the given elements to array , returns a new array
